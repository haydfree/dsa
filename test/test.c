...
test_lc_push_front_basic(void)
{
    ...
    TEST_ASSERT(dsa_lc_push_front(&fixture.list, (void*)&data1) == EXIT_SUCCESS, "Failed to push first element");
    ...
    TEST_ASSERT(dsa_lc_push_front(&fixture.list, (void*)&data2) == EXIT_SUCCESS, "Failed to push second element");
    ...
    TEST_ASSERT(dsa_lc_push_front(NULL, NULL) == EXIT_FAILURE, "Should fail with NULL list");
    TEST_ASSERT(dsa_lc_push_front(&fixture.list, NULL) == EXIT_FAILURE, "Should fail with NULL data");
...
test_lc_push_front_edge_cases(void)
{
    ...
    TEST_ASSERT(dsa_lc_push_front(&fixture.list, (void*)&data) == EXIT_SUCCESS, "Failed to push to empty list");
    verify_list_state(&fixture.list, 1, fixture.capacity - 1);
    TEST_DUMP_LIST_STATE(&fixture.list);
    ...
    for (; i < fixture.capacity - 1; i++) 
    {
        ...
        TEST_ASSERT(dsa_lc_push_front(&fixture.list, (void*)&data) == EXIT_SUCCESS, "Failed to push to non-full list");
    ...
    TEST_ASSERT(dsa_lc_push_front(&fixture.list, (void*)&data) == EXIT_FAILURE, "Should fail to push to full list");
